...
import static org.lwjgl.opengl.ARBShaderSubroutine.glUniformSubroutinesuiv;
import static org.lwjgl.opengl.GL20.*;
import static org.lwjgl.opengl.GL32.GL_GEOMETRY_SHADER;
import us.kosdt.arl.util.Resources;
import us.kosdt.arl.util.math.Transformation;
...
public class Shader extends GLObject {
    ...
    public static Shader loadGeom(String vert, String geom, String frag) {
        return new Shader(
                vert == null ? null : Resources.loadFileAsString("shaders/" + vert + ".vert"),
                geom == null ? null : Resources.loadFileAsString("shaders/" + geom + ".geom"),
                frag == null ? null : Resources.loadFileAsString("shaders/" + frag + ".frag"));
    }
